# Lyzr GitAgent Hiring Challenge — Submission (Soumi Guria)
...
### Current Role / What are you currently building?

> I am an **experienced builder** (~3 years): Co-Founder & CMO at **DhandaEasy**, former **Backend Developer** at Intelligent Inspirations, and **App Lead** at GDG On Campus NSEC. I am GATE CS 2026 qualified and an MLH track winner. Right now I am shipping **GhostTrace AI** — a GitAgent-defined, LangGraph-powered cyber investigation lab with a FastAPI backend and Next.js live dashboard — for the Lyzr GitAgent hiring challenge.
...
`[ADD YOUR LOOM/YOUTUBE URL BEFORE SUBMIT]`
